...
def run_generation(source_dir: Path, prefix: Optional[str] = None, force: bool = False):
    ...
    frame_prompts = (
        f"Create Frame 1 for a 9:16 TikTok Shop keyframe. Photorealistic full-body lifestyle fashion photo of an adult Malaysian Muslim woman wearing the exact product described, paired with modern modest trousers and a neat light-ivory chiffon bawal hijab. She faces the camera with relaxed shoulders, a natural gentle smile, and comfortable eye contact. Modern Kuala Lumpur covered walkway with a neutral cafe facade softly blurred behind her. Soft golden-hour daylight, natural skin texture, editorial realism, full outfit visible head to toe. Both arms rest naturally by her sides with empty hands. Strictly no handbag, no tote bag, no purse, no tumbler, no props, no text overlay, no logo, no watermark, no price, no raised hands, no waving. {base_desc}",
        f"Create Frame 2 for a 9:16 TikTok Shop keyframe. Keep the same adult Malaysian Muslim woman, face, hijab, outfit, trousers, shoes, and Kuala Lumpur background as Frame 1. Turn her gently to her left into a 3/4 side profile, showing the relaxed silhouette and drape. Full outfit visible head to toe. Both arms rest relaxed at her sides with empty hands, one hand may lightly touch the side seam. Strictly no handbag, no tote bag, no purse, no tumbler, no props. Soft daylight, photorealistic editorial lifestyle image. No text overlay, no logo, no watermark, no price, no raised hands, no waving. {base_desc}",
        f"Create Frame 3 for a 9:16 TikTok Shop keyframe. Keep the same adult Malaysian Muslim woman, face, hijab, outfit, trousers, shoes, and Kuala Lumpur background as Frames 1 and 2. She faces mostly away from the camera, then gives a gentle glance back over her right shoulder with a soft natural smile. Show the back silhouette and modest relaxed fit. Full outfit visible head to toe. Both arms remain naturally low by her sides with empty hands. Strictly zero props, no handbag, no tote bag, no purse, no tumbler, no accessories. Soft daylight. No text overlay, no logo, no watermark, no price, no raised hands, no waving. {base_desc}",
    )
